        ...
        if (kknWords.length > 0) {
          tl.fromTo(
            ...
            },
            {
              ...
              filter: 'blur(0px)',
              y: 0,
              fontWeight: (_i, el) => el.getAttribute('data-variant') === 'cyan' ? 700 : 600,
              color: (_i, el) => el.getAttribute('data-variant') === 'cyan' ? '#a5f3fc' : 'rgba(255, 255, 255, 0.95)',
              textShadow: (_i, el) => el.getAttribute('data-variant') === 'cyan' ? '0 0 18px rgba(6, 182, 212, 0.9)' : '0 0 12px rgba(255, 255, 255, 0.4)',
              stagger: 0.02,
              duration: 0.45,
            },
            '-=0.55'
        ...
        if (bpomWords.length > 0) {
          tl.fromTo(
            ...
            },
            {
              ...
              filter: 'blur(0px)',
              y: 0,
              fontWeight: (_i, el) => el.getAttribute('data-variant') === 'violet' ? 700 : 600,
              color: (_i, el) => el.getAttribute('data-variant') === 'violet' ? '#ddd6fe' : 'rgba(255, 255, 255, 0.95)',
              textShadow: (_i, el) => el.getAttribute('data-variant') === 'violet' ? '0 0 18px rgba(139, 92, 246, 0.9)' : '0 0 12px rgba(168, 85, 247, 0.4)',
              stagger: 0.02,
              duration: 0.45,
            },
            '-=0.55'
