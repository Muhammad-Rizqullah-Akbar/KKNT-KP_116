  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/dashboard/partnership/cadres', icon: 'users', label: 'Kelola Kader Mitra', badge: 'Mitra' },
    ...
    <>
      ...
      <aside
        className={clsx(
          ...
          'flex flex-col w-64 md:w-72 bg-[#080812] border-r border-white/[0.06]',
      ...
      >
        {/* ============ LOGO UTAMA SIDEBAR ============ */}
        <div className="p-4 md:p-5 border-b border-white/[0.06] flex-shrink-0 bg-white/[0.01]">
          <Link href="/dashboard/overview" className="flex items-center gap-3 group">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-display font-bold text-sm block leading-tight text-white group-hover:text-cyan-400 transition-colors">
              ...
              <span className="text-[10px] text-white/40 font-medium">Desa Pangan Aman</span>
            </div>
          </Link>
        </div>
        ...
        <div className="p-3 border-t border-white/[0.06] flex-shrink-0 bg-white/[0.01]">
          <button
            ...
            className="w-full flex items-center gap-3 p-2 rounded-xl hover:bg-white/[0.04] transition-colors group text-left border border-transparent hover:border-white/[0.05]"
          >
